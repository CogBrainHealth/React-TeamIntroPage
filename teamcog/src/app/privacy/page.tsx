      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <p className="text-base">
            Cog콕 (이하 ‘회사’라 함)은 회사가 제공하고자 하는 서비스 (이하 '회사
            서비스’)를 이용하는 개인 (이하 ‘이용자’ 또는 ‘개인’)의 정보 (이하
            ‘개인정보’)를 보호하기 위해 개인정보보호법과 정보통신망 이용촉진 및
            정보보호 등에 관한 법률 (이하 ’정보통신망법’) 등 관련 법령을
            준수하며, 서비스 이용자의 개인정보 보호와 관련한 고충을 신속하고
            원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침
            (이하 ‘본 방침’)을 수립합니다.
          </p>
        </div>
        {/* --- 제2조 (개인정보 처리의 원칙) --- */}
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <ol className="list-decimal list-inside text-base">
            <li>
              필수수집 정보: 이메일 주소, 비밀번호, 이름, 닉네임, 생년월일 및
              휴대폰 번호
            </li>
          </ol>
        </div>
        ...
        {/* --- 제7조 (기타 수집 정보) --- */}
        <div className="mb-10 leading-relaxed">
          <h2 className="text-xl font-semibold mb-4">제7조 (기타 수집 정보)</h2>
          <p className="text-base">회사는 아래와 같이 정보를 수집합니다.</p>
          <ol className="list-decimal list-inside text-base">
            <li>
              수집목적: 건강관리 목적의 설문 및 게임 기반 분석 결과를 통해 건강
              정보를 제공합니다. 이 과정에서 수집되는 정보는 ‘민감정보
              (건강정보)’에 해당할 수 있으며, 사용자의 명시적 동의를 기반으로만
              처리됩니다.
            </li>
            <li>
              수집정보: 식/생활 패턴, 게임 플레이 데이터 (점수), 민감정보에
              해당할 수 있는 건강 정보
            </li>
          </ol>
        </div>
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <ol className="list-decimal list-inside text-base">
            ...
            <li>
              ...
              이용행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한
              방지 및 제재를 위한 경우
            </li>
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <ol className="list-decimal list-inside text-base">
            <li>
              ...
              공개하거나 다음 각 호 사항에 대하여 동의한 경우에는 제3자에게
              제공할 수 있습니다. 다만 이 경우에도 회사는 관련 법령 내에서
              최소한으로 개인정보를 제공합니다.
              <ul className="list-disc list-inside ml-4">
                <li>
                  가. 네이버(네이버 주식회사), 카카오(카카오 주식회사),
                  구글(Google LLC)에게 소셜 로그인 기능 제공 및 사용자 계정
                  인증을 위하여 회원가입, 서비스 이용을 위해 수집한 정보를
                  제공합니다.
                </li>
              </ul>
            </li>
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <ol className="list-decimal list-inside text-base">
            <li>
              ...
              보유 기간
              <ul className="list-disc list-inside ml-4">
                <li>가. 계약 또는 청약 철회에 관한 기록: 5년</li>
                <li>나. 대금 결제 및 재화 등의 공급에 관한 기록: 5년</li>
                <li>다. 소비자의 불만 또는 분쟁 처리에 관한 기록: 3년</li>
                <li>라. 표시·광고에 관한 기록: 6개월</li>
              </ul>
            </li>
            <li>
              통신비밀 보호법에 따른 보유 정보 및 보유 기간
              <ul className="list-disc list-inside ml-4">
                <li>가. 웹사이트 로그 기록 자료: 3개월</li>
              </ul>
            </li>
            <li>
              전자금융 거래법에 따른 보유 정보 및 보유 기간
              <ul className="list-disc list-inside ml-4">
                <li>가. 전자금융 거래에 관한 기록: 5년</li>
              </ul>
            </li>
            <li>
              위치정보의 보호 및 이용 등에 관한 법률
              <ul className="list-disc list-inside ml-4">
                <li>가. 개인 위치정보에 관한 기록: 6개월</li>
              </ul>
            </li>
          </ol>
        </div>
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <ol className="list-decimal list-inside text-base">
            <li>
              ...
              및 기타 관련 법령에 의한 정보 보호 사유에 따라(보유 및 이용 기간
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <ol className="list-decimal list-inside text-base">
            <li>
              회사는 전자적 전송 매체를 이용하여 영리 목적의 광고성 정보를
              전송하는 경우 이용자의 명시적인 사전 동의를 받습니다. 다만, 다음
              각호 어느 하나에 해당하는 경우에는 사전 동의를 받지 않습니다.
              <ul className="list-disc list-inside ml-4">
                <li>
                  가. 회사가 재화 등의 거래 관계를 통해 수신자로부터 직접
                  연락처를 수집한 경우, 거래가 종료된 날로부터 6개월 이내에
                  회사가 처리하고 수신자와 거래한 것과 동종의 재화 등에 대한
                  영리 목적의 광고성 정보를 전송하려는 경우
                </li>
                <li>
                  나. 「방문판매 등에 관한 법률」에 따른 전화 권유 판매자가
                  육성으로 수신자에게 개인정보의 수집 출처를 고지하고 전화
                  권유를 하는 경우
                </li>
              </ul>
            </li>
            <li>
              회사는 전항에도 불구하고 수신자가 수신 거부 의사를 표시하거나 사전
              동의를 철회한 경우에는 영리 목적의 광고성 정보를 전송하지 않으며,
              수신 거부 및 수신 동의 철회에 대한 처리 결과를 알립니다.
            </li>
            <li>
              회사는 오후 9시부터 그 다음 날 오전 8시까지의 시간에 전자적 전송
              매체를 이용하여 영리 목적의 광고성 정보를 전송하는 경우에는
            ...
            <li>
              ...
              <ul className="list-disc list-inside ml-4">
                <li>가. 회사명 및 연락처</li>
                <li>
                  나. 수신 거부 또는 수신 동의의 철회 의사 표시와 관련된 사항의
                  표시
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul className="list-disc list-inside ml-4">
                <li>
                  가. 광고성 정보 수신자의 수신 거부 또는 수신 동의의 철회를
                  회피·방해하는 조치
                </li>
                <li>
                ...
                <li>
                  다. 영리 목적의 광고성 정보를 전송할 목적으로 전화번호 또는
                ...
                <li>
                  마. 영리 목적의 광고성 정보를 전송할 목적으로 수신자를
                  기망하여 회신을 유도하는 각종 조치
                </li>
              </ul>
            </li>
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <ol className="list-decimal list-inside text-base">
            ...
            <li>
              ...
              또는 전자우편으로 연락하시면 회사는 지체 없이 조치하겠습니다.
            </li>
          </ol>
        </div>
        {/* --- 제19조(개인정보 정보변경 등) --- */}
        ...
        {/* --- 제20조(이용자의 의무) --- */}
        <div className="mb-10 leading-relaxed">
          <h2 className="text-xl font-semibold mb-4">제20조(이용자의 의무)</h2>
          <ol className="list-decimal list-inside text-base">
            <li>
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <p className="text-base">
            ...
            유출, 변조, 훼손되지 않도록 안전성을 확보하기 위해 필요한 기술적 및
            관리적 보호대책을 강구하고 있습니다.
          </p>
        </div>
        {/* --- 제22조(삭제된 정보의 처리) --- */}
        <div className="mb-10 leading-relaxed">
          ...
          <p className="text-base">
            ...
            개인정보는 회사가 수집하는 "개인정보의 보유 및 이용 기간"에 명시된
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <ol className="list-decimal list-inside text-base">
            ...
            <li>
              회사는 최신 백신 프로그램을 이용하여 이용자들의 개인정보나 자료가
              유출 또는 손상되지 않도록 방지하고 있습니다.
            </li>
            <li>
              회사는 만일의 사태에 대비하여 침입 차단 시스템을 이용하여 보안에
              최선을 다하고 있습니다.
            </li>
            <li>
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <p className="text-base">
            ...
            처리자에 대한 교육 등 관리적 조치를 통해 법령 및 내부 방침 등의
            준수를 강조하고 있습니다.
          </p>
        </div>
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <ol className="list-decimal list-inside text-base">
            ...
            <li>
              회사는 이용자의 개인정보를 국외에 제공(조회되는 경우를 포함), 처리
              위탁, 보관(이하 "이전"이라 함)하려면 이용자의 동의를 받습니다.
              다만, 본조 제3항 각 호의 사항 모두를 개인정보보호법 등 관계 법규에
              따라 공개하거나 전자우편 등 대통령령으로 정하는 방법에 따라
              이용자에게 알린 경우에는 개인정보 처리 위탁, 보관에 따른 동의
              절차를 거치지 아니할 수 있습니다.
            </li>
            <li>
              ...
              <ul className="list-disc list-inside ml-4">
                ...
                <li>나. 개인정보가 이전되는 국가, 이전 일시 및 이전 방법</li>
                <li>
                  다. 개인정보를 이전받는 자의 성명(법인인 경우 그 명칭 및
                  정보관리 책임자의 연락처를 말한다)
                </li>
                <li>
                  라. 개인정보를 이전받는 자의 개인정보 이용 목적 및 보유, 이용
                  기간
                </li>
              </ul>
            </li>
            <li>
              ...
              이전하는 경우 개인정보보호법 대통령령 등 관계 법규에서 정하는 바에
              따라 보호 조치를 합니다.
            </li>
          </ol>
        </div>
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <ol className="list-decimal list-inside text-base">
            <li>
              ...
              사용합니다. 쿠키는 웹사이트를 운영하는 데 이용되는 서버(http)가
              ...
              <ul className="list-disc list-inside ml-4">
                <li>
                  ...
                  <ul className="list-disc list-inside ml-4">
                    <li>1) 성명: 최효진</li>
                    <li>2) 직책: CEO</li>
                    <li>3) 전화번호: 010-2931-7692</li>
                    <li>4) 이메일: erica9668@naver.com</li>
                  </ul>
                </li>
              </ul>
            </li>
        ...
        <div className="mb-10 leading-relaxed">
          ...
          <ol className="list-decimal list-inside text-base">
            <li>
              정보주체는 개인정보 침해로 인한 구제를 받기 위하여 개인정보 분쟁
              조정 위원회, 한국인터넷진흥원 개인정보 침해 신고 센터 등에 분쟁
              해결이나 상담 등을 신청할 수 있습니다. 이 외에 기타 개인정보
              침해의 신고, 상담에 대하여는 아래의 기관에 문의하시기 바랍니다.
              <ul className="list-disc list-inside ml-4">
                <li>
                  가. 개인정보 분쟁 조정 위원회 : (국번 없이) 1833-6972
                  (www.kopico.go.kr)
                </li>
                <li>
                  나. 개인정보 침해 신고 센터 : (국번 없이)118
                  (privacy.kisa.or.kr)
                </li>
            ...
            <li>
              회사는 정보주체의 개인정보자기결정권을 보장하고, 개인정보 침해로
              인한 상담 및 피해 구제를 위해 노력하고 있으며, 신고나 상담이
              필요한 경우 제 1항의 담당 부서로 연락해 주시기 바랍니다.
            </li>
            <li>
        ...
        <div className="mt-10 leading-relaxed">
          ...
          <ol className="list-decimal list-inside text-base">
            <li>본 방침은 2025.03.04부터 시행됩니다.</li>
          </ol>
        </div>
      </div>
    </div>
